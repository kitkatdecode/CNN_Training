...
train_datagen = ImageDataGenerator(rescale=1.0/255) #rescaling from [0,255] to [0,1]
...
model.compile(loss="binary_crossentropy", 
              ...
              metrics=['acc']) # RMSprop better than SGD for image datas; default lr =0.1
...
model_history = model.fit_generator(
                    ...
                    validation_steps= 50,
                    callbacks=[chk_cb])   ## fit_generator becoz data is coming from director using train generator
                                            ## steps_per_epochs - number of steps for 1 epoch to take data in 2000/batch_size
